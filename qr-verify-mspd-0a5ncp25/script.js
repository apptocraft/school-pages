...
<div class="container">
    <div class="card" style="padding:40px;text-align:center;max-width:700px;margin:auto;">
        ...
        <p>
            Debagram, Katwa More, Kaliganj<br>
        ...
        <p>
            <strong>Mobile:</strong> 9647097306 / 9635706610<br>
            <strong>Email:</strong> modelstudypoint@gmail.com
        </p>

        <p style="margin-top:25px;color:#777;font-size:13px;">
            © ${new Date().getFullYear()} Model Study Point<br>
            All Rights Reserved
        </p>
...
.then(student => {
    ...
    document.getElementById("idno").textContent = student.id_no;
